...
// @formatter:on
        ...
        ready(function () {
            ...
            mapMain.on("load", function () {
                ...
                /*
                *Step: Add a print widget that uses the prepared template
                */
            ...
            function calculateViewshed(evt) {
                ...
                //fsInputPoint.push(graphicViewpoint);
            ...
            function displayViewshed(results, messages) {
                ...
                //var arrayFeatures = gpFeatureRecordSetLayer.fsInputPoint;
                ...
                array.forEach(arrayFeatures, function (feature) {
                    ...
                    //en la línea de abajo ponía features, en vez de feature, y por eso daba error.
